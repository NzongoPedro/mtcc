            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="./" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">MTCC</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Direção</p>
                  </div>
                  ...
                  <form class="row g-3 needs-validation form" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Forneça um email válido!</div>
                    </div>
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Palavra-passe</label>
                      <input type="password" name="password" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Crie uma Palavra-passe!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Já possuí uma conta? <a href="pages-login.php">Iniciar sessão</a></p>
                    </div>
                    <input type="hidden" name="acao" value="criar-conta-adm">
                  </form>
